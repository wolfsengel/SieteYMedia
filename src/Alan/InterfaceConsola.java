...
class InterfaceConsola{
    ...
    public void presentacion(){
        ...
        System.out.println(
                "- Si el jugador no se pasa, comienza a sacar cartas la banca y Ã©sta estÃ¡ obligada a sacar cartas hasta empatar o superar al jugador.");
        System.out.println(
                "- Si la banca consigue empatar o superar la puntuaciÃ³n del jugador 'sin pasarse de siete y medio', gana la banca.");
        System.out.println(
                "- La banca no se puede plantar y tiene que empatar o superar la puntuaciÃ³n del jugador sin pasarse.");
        System.out.println(
    ...
    public void juego(){
        ...
        double valorCartasJugador = juego.valorCartas(juego.cartasJugador);
